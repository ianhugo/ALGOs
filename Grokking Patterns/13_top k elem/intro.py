...
1. Top K, want k largest elements
- k sized min heap
...
3. Repeated elements, not used consecutively (rearrange str)
- keep node outside
...
4. Repeated elements, used K apart (scheduling task)
...
6. Connect groups min cost
- cost of connecting is the size of group
- keep min heap
- pop two off, connect
- pop it back in
